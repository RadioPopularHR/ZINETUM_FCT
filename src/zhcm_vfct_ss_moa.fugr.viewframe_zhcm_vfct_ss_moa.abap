*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHCM_VFCT_SS_MOA
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHCM_VFCT_SS_MOA    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHCM_VFCT_SS_MOA'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHCM_VFCT_SS_MOA_EXTRACT
TOTAL = ZHCM_VFCT_SS_MOA_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHCM_VFCT_SS_MOA'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHCM_VFCT_SS_MOA-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHCM_VFCT_SS_MOA_EXTRACT
TOTAL = ZHCM_VFCT_SS_MOA_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHCM_VFCT_SS_MOA-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHCM_VFCT_SS_MOA'
...
TOTAL = ZHCM_VFCT_SS_MOA_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHCM_VFCT_SS_MOA-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHCM_VFCT_SS_MOA-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHCM_VFCT_SS_MOA'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHCM_VFCT_SS_MOA-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHCM_VFCT_SS_MOA_EXTRACT
TOTAL = ZHCM_VFCT_SS_MOA_TOTAL
