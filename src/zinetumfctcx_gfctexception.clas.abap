class ZINETUMFCTCX_GFCTEXCEPTION definition
  public
...
public section.
  ...
  data FAULT type ZINETUMFCTWS_SERVICE_FAULT read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !FAULT type ZINETUMFCTWS_SERVICE_FAULT optional
...
CLASS ZINETUMFCTCX_GFCTEXCEPTION IMPLEMENTATION.
